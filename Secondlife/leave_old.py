    ...
    <div class="" id="wrapper">
        ...
        <div id="content">
            <div class="container-fluid">
                ...
                <h1 style="color: var(--primary-color);">Old Leaves</h1>
                <div class="table-responsive">
                        <table class="table table-striped table-hover align-middle">
                            <thead>
<tr class="mt-5" style="color: var(--sidebar-color); background-color: var(--primary-color);">
...
for i in ress:
    ...
    <td>%s</td>
    <td>%s</td>
    """ % (si, formatted_date, i[1], i[3], i[4], i[5], i[7]))
    si += 1
