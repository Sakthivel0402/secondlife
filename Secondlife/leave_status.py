...
<head>
    ...
    <script>
        ...
        function requestNewLeave() {
            location.href = "doctor_leave.py?id=%s";
        }
    </script>
</head>
""" % did)
        ...
        <div class="" id="sidebar">
            ...
            <div class="sidebar-content">
                <ul class="list-unstyled components">
                    ...
                    <li class="active">
                        <a href="#leaveSubmenu" data-bs-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <i class="bi bi-calendar-x"></i> Leave
                        </a>
                        <ul class="collapse list-unstyled show" id="leaveSubmenu">
                            <li>
                                <a href="doctor_leave.py?id={did}"><i class="bi bi-plus-circle"></i> New Request</a>
                            </li>
                            <li class="active">
                                <a href="leave_status.py?id={did}" style="text-decoration: underline #2d5b83 2px;"><i class="bi bi-list-check"></i> Status</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="content">
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 style="color: var(--primary-color);">Leave Requests</h1>
                    <button class="btn btn-primary" onclick="requestNewLeave()">
...
b = """select * from leaves where Name='%s'""" % (res[0][1])
cur.execute(b)
ress = cur.fetchall()
...
for i in ress:
    ...
    <tr>
        ...
        <td>{i[4]}</td>
        <td>{i[5]}</td>
        <td><span class="status-badge {status_class}">{i[7]}</span></td>
    </tr>
    """)
    si += 1
