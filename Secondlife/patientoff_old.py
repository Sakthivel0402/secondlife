        ...
        <div id="content">
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-center align-items-center mb-4">
                    <h1 style="color: var(--primary-color);">Completed Appointments</h1>
                </div>
""")

b = """select * from addicted where status='Completed' and mode='offline'"""
cur.execute(b)
res = cur.fetchall()

print("""
                <div class="table-container">
                    <h3>Addicted Patients</h3>
...
for i in res:
    ...
    <tr>
        ...
        <td>{i[2]}</td>
        <td>{i[5]}</td>
        <td><span class="badge bg-success">{i[9]}</span></td>
        <td>
    ...
    <!-- Modal for Reset Status -->
    <div class="modal fade" id="myModal{i[0]}" tabindex="-1" aria-labelledby="resetModalLabel{i[0]}" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="resetModalLabel{i[0]}">Reset Appointment Status</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to reset this appointment's status to 'Pending'?</p>
                    <form method="post">
...
id = form.getvalue("ID")
if sub != None:
    j = """update addicted set status='Pending' where id='%s'""" % (id)
    cur.execute(j)
    con.commit()
    print("""
    <script>
...
e = """select * from aware where status='Completed' and mode='offline'"""
cur.execute(e)
ret = cur.fetchall()

print("""
                <div class="table-container mt-4">
                    <h3>Aware Patients</h3>
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            <thead class="thead-dark">
                                <tr>
...
""")
if ret==():
    print("""<h4 class="text-danger text-center">No data found.</h4>""")
else:
    ...
    for i in ret:
        ...
        <tr>
            ...
            <td>{i[2]}</td>
            <td>{i[4]}</td>
            <td><span class="badge bg-success">{i[8]}</span></td>
            <td>
                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#myModalAware{i[0]}">
                    Reset Status
                </button>
            </td>
        </tr>
        ...
        <!-- Modal for Reset Status -->
        <div class="modal fade" id="myModalAware{i[0]}" tabindex="-1" aria-labelledby="resetModalLabelAware{i[0]}" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="resetModalLabelAware{i[0]}">Reset Appointment Status</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>Are you sure you want to reset this appointment's status to 'Pending'?</p>
